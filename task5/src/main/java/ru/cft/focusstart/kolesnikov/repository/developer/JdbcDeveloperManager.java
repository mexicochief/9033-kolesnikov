...
public class JdbcDeveloperManager implements DeveloperDBManager {
    ...
    private static final String ADD = "INSERT INTO developer(name, description) " +
            "values (?,?)";
    private static final String GET_BY_NAME = "SELECT * FROM developer " +
            "WHERE lower(name) LIKE lower('%'|| ? ||'%')";
    private static final String GET_BY_ID = "SELECT * from developer " +
            "WHERE id = ? ";
    private static final String UPDATE = "UPDATE developer " +
